...
Donate link: https://digitalreliance.co.za
Tags: social, twitter
...
1. A screen shot of the Plugin's Settings Page
2. A screen shot on the Front End of the website, using the Wordpres Widget functionality

== Changelog ==

= 1.0.1 =
* Updated "Tested up to" to 4.8.1
* Minor version update
* Added some assets to repository
